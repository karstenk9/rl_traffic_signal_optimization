...
env = custom_env.MA_grid_train(use_gui=False,
                            ...
                            out_csv_name='/Users/jenniferhahn/Documents/GitHub/urban_mobility_simulation/src/data/model_outputs/avg_brake_NEW_200000',
                            additional_sumo_cmd="--emission-output /Users/jenniferhahn/Documents/GitHub/urban_mobility_simulation/src/data/model_outputs/emission_avg_brake_NEW.xml, \
                                                --lanedata-output /Users/jenniferhahn/Documents/GitHub/urban_mobility_simulation/src/data/model_outputs/lane_avg_brake_NEW.xml",
                            )
...
model = PPO(
    ...
    clip_range=0.3,
    batch_size=64,
    tensorboard_log="./logs/MA_grid/avg_brake_NEW",
...
model.save('urban_mobility_simulation/src/data/logs/avg_brake_NEW_200')
