...
if __name__ == "__main__":
    ...
    prs.add_argument("-f", nargs="+", default="urban_mobility_simulation/src/data/model_outputs/", required=False, help="Measures files\n")
    prs.add_argument("-l", nargs="+", default=None, help="File's legends\n")
    prs.add_argument("-t", type=str, default="", help="Plot title\n")
    prs.add_argument("-yaxis", type=str, default="system_local_CO2", help="The column to plot.\n")
